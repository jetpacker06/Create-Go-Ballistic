package com.jetpacker06.allthecogs.datagen.recipeproviders;
...
public class AllTheCogsVanillaRecipes extends RecipeProvider implements IConditionBuilder {

    public AllTheCogsVanillaRecipes(DataGenerator generator) {
        super(generator);
    }
